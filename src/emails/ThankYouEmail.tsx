...
const projectsLink = "https://www.jonathanmendoza.dev/projects";
const githubLink = "https://github.com/Jnmendza";
const linkedInLink = "https://www.linkedin.com/in/jnmendza/";

export const ThankYouEmail = ({ name }: EmailProps) => (
  <Html>
    <Head />
    <Tailwind>
      <Body className='bg-[#161b22] font-sans'>
        ...
        <Container className='mx-auto pt-5 px-[25px] pb-12 text-white  bg-bottom bg-no-repeat'>
          ...
          <Section className='my-6 text-base leading-[26px]'>
            ...
            <Text className=''>
              Thank you for getting in touch via my portfolio site. I truly
              appreciate you taking the time to reach out, and I’ll review your
              inquiry ASAP.
            </Text>
            <Text>
              In the meantime, feel free to explore my latest projects here:
            </Text>
            <Container className='flex justify-center mt-6'>
              <Button
                className='rounded bg-[#d5ff3f] px-5 py-3 text-center font-semibold  text-[#161b22] no-underline '
                href={projectsLink}
              >
                Projects
              </Button>
